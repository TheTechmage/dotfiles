...
export TMPDIR=/tmp
export PATH=$PATH:$HOME/bin:$HOME/fbin:/usr/lib/surfraw:$HOME/.gem/ruby/2.0.0/bin:$HOME/go/bin:$HOME/.gem/ruby/2.2.0/bin
PS1='\[\e[1;34m\]\u\[\e[0;31m\]\w\[\e[0;32m\]\$\[\e[0m\] '
PS1='\[\e[1;34m\]\u\[\e[0;33m\]\h\[\e[0;31m\]\W\[\e[0;32m\]\$\[\e[0m\] '
export EDITOR="vim"
